...
targets <- read.metharray.sheet(RawDataDir) # should the samplesheet be csv like in our dataset? # check also the columns some must be there 
...
dim(RGset) #1105209 # assays red + green
...
## 3- MDS plot (multi dimensional scaling plot) samples PCA
```{r}
